...
export default function OrientationForm() {
  ...
  return (
    <div className="w-full">
      <Card>
        {/* The entire form section remains the same as before */}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label htmlFor="fieldOfInterest" className="block text-sm font-medium text-gray-700 dark:text-gray-300 text-right mb-2">مجال الاهتمام (اختياري)</label>
              <select id="fieldOfInterest" value={selectedField} onChange={(e) => setSelectedField(e.target.value)} className="mt-1 block w-full pl-3 pr-10 py-3 text-base border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-xl text-right">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <Card className="mb-8">
                <div className="grid grid-cols-1 gap-4">
                  {/* Search Input */}
                  <div className="">
                    <label htmlFor="search" className="block text-sm font-medium text-gray-700 dark:text-gray-300 text-right mb-1">ابحث (بالاسم، الجامعة، الرمز او الولاية)</label>
                    <input
                      type="text"
                      id="search"
                      value={searchQuery}
                      ...
                      className="mt-1 block w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    />
                  </div>
